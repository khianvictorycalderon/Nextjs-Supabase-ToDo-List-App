    ...
    <div className="min-h-screen bg-red-900 flex flex-col">
      ...
      <div className="bg-gray-900 text-white p-4">
        ...
        <form onSubmit={(e) => handleAddTask(e, taskInputName)} className="my-4 justify-center items-center flex flex-col lg:flex-row gap-2 lg:gap-6">
          ...
          <input disabled={isAddingTask} value={taskInputName} onChange={(e) => setTaskInputName(e.target.value)} name="task-name-input" className="bg-gray-50 text-black text-lg p-1 rounded-md w-full lg:w-[30%] outline-0 focus:ring-blue-600 focus:ring-2 shadow focus:shadow-2xl" type="text" />
